...
vinyl-dj-library/
  ...
  api/
    ...
    routes/
      ...
      tap_bpm.py            -- GET /tap-bpm, the live tap-tempo BPM counter page
  sync/
  ...
  web/
    ...
    static/
      ...
      tap-bpm.js          -- vendored, no dependency: tap-tempo BPM calculation for the
                              /tap-bpm page (rolling average of last 8 taps, resets after
                              a 2s gap, spacebar shortcut)
      style.css
```
